...
class TTSController(Module):
    def __init__(self, **kwargs):
        ...
        self.prepend = kwargs.get("prepend", "[:phoneme on]")
        self.append = kwargs.get("append", "")
        self.char_limit = int(kwargs.get("char_limit", 1250))
        self.newline_replacement = kwargs.get("newline_replacement", "[_<250,10>]")
        self.output_extension = kwargs.get("output_extension", "wav")
        self.wine = kwargs.get("wine", "wine")
        self.xvfb_prepend = kwargs.get("xvfb_prepend", "DISPLAY=:0.0")
        self.is_headless = kwargs.get("headless", False)
